class Icon {
    constructor(saveData) {
        ...
        if (saveData) {
            ...
            let clickedHexCoords = worldToAxial(primaryToolData.worldX, primaryToolData.worldY, primaryHexfield.orientation, primaryHexfield.hexWidth, primaryHexfield.hexHeight);
            this.spr_icon.position.set(clickedHexCoords.x, clickedHexCoords.y);
