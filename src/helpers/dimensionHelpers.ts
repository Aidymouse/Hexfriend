...
export const getShiftForSquareExpansion = (direction: 'left', amount: number, hexInfo: HexSizeParams & { raised: HexRaised }): SquareDimensionShiftResults => {
