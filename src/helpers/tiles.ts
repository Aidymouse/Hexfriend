...
export const getStoreableTile = (tile: Tile): Tile => {
  ...
  // } else {
  //   let constructedTile = {symbol: {}}
  //   for (const tileKey of Object.keys(tile)) {
  //     if (tileKey === 'symbol') { continue }
  //     constructedTile[tileKey] = tile[tileKey]
  //   }
  //
  //   for (const symbolKey of Object.keys(tile.symbol)) {
  //     if (symbolKey === 'base64') {
  //       continue
  //     }
  //     constructedTile.symbol[symbolKey] = tile.symbol[symbolKey]
  //   }
  //
  //   return structuredClone(constructedTile)
  //
  // }
}
