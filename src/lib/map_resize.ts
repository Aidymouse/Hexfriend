...
export const find_new_pos_through_resize = (
 ...
 * */
export const find_new_pos_square_orientation_change = (
  pos: { x: number; y: number },
  old_hex_size: HexSizeParams,
  new_hex_size: HexSizeParams,
  ...
  let conservedClosestHexRowCol =
    oldOrientation == 'flatTop'
      ? coords_cubeToq(cur_raised, oldClosestHexCubeCoords.q, oldClosestHexCubeCoords.r, oldClosestHexCubeCoords.s)
      : coords_cubeTor(cur_raised, oldClosestHexCubeCoords.q, oldClosestHexCubeCoords.r, oldClosestHexCubeCoords.s)

  // Find the hex position of the hex at the same row/col, but opposite orientation
  let newHexCubeCoords =
    new_hex_size.orientation === HexOrientation.FLATTOP
