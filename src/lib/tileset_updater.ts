...
export function update_map_to_new_default_tileset(tfield: TerrainField) {
  ...
  if (!covered_in_map) {
    alert(
      'Default tiles could not be updated. You are on an as-of-yet unaccounted for version of the old tileset. Please export your map as a .hexfriend and upload it to https://github.com/Aidymouse/Hexfriend/issues/25.',
    )
    return false
  }
